...
from app.routers.labels import router, read_labels, create_label as create_label_route, read_label, update_label as update_label_route, delete_label as delete_label_route
from app.schemas import LabelCreate, LabelUpdate, LabelResponse
from app.services.label import get_labels, get_label, get_label_by_name, create_label, update_label, delete_label
        ...
        with patch('app.routers.labels.label_service.get_labels') as mock_get_labels:
            ...
            with patch('app.routers.labels.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.labels.get_db') as mock_db:
                    ...
                    result = asyncio.run(read_labels(
                        0, 100,
            ...
            with patch('app.routers.labels.label_service.create_label') as mock_create:
                ...
                with patch('app.routers.labels.get_current_active_user') as mock_current_user:
                    ...
                    with patch('app.routers.labels.get_db') as mock_db:
                        ...
                        result = asyncio.run(create_label_route(
                            label_data, 
                            mock_db.return_value.__enter__.return_value, 
                            admin_user
                        ))
        ...
        with patch('app.routers.labels.require_admin') as mock_require_admin:
            ...
            with patch('app.routers.labels.get_db') as mock_db:
                ...
                with pytest.raises(HTTPException) as exc_info:
                    asyncio.run(create_label_route(
                        label_data,
                        mock_db.return_value.__enter__.return_value,
                        mock_require_admin()
                    ))
        ...
        with patch('app.routers.labels.label_service.update_label') as mock_update:
            ...
            with patch('app.routers.labels.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.labels.get_db') as mock_db:
                    ...
                    result = asyncio.run(update_label_route(
                        1, 
                        update_data, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
    ...
    def test_update_label_permission_denied(self, regular_user):
        ...
        with patch('app.routers.labels.require_admin') as mock_require_admin:
            ...
            with patch('app.routers.labels.get_db') as mock_db:
                ...
                with pytest.raises(HTTPException) as exc_info:
                    asyncio.run(update_label_route(
                        1,
                        update_data,
                        mock_db.return_value.__enter__.return_value,
                        mock_require_admin()
        ...
        with patch('app.routers.labels.label_service.delete_label') as mock_delete:
            ...
            with patch('app.routers.labels.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.labels.get_db') as mock_db:
                    ...
                    result = asyncio.run(delete_label_route(
                        1, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
                    ))
    ...
    def test_delete_label_permission_denied(self, regular_user):
        ...
        with patch('app.routers.labels.require_admin') as mock_require_admin:
            ...
            with patch('app.routers.labels.get_db') as mock_db:
                ...
                with pytest.raises(HTTPException) as exc_info:
                    asyncio.run(delete_label_route(
                        1,
                        mock_db.return_value.__enter__.return_value,
                        mock_require_admin()
                    ))
