...
from app.routers.lists import router, read_lists, create_list as create_list_route, read_list, update_list as update_list_route, delete_list as delete_list_route, get_list_cards_count, reorder_lists as reorder_lists_route, require_admin
from app.schemas import (
    KanbanListCreate, KanbanListUpdate, KanbanListResponse, 
    ListDeletionRequest, ListReorderRequest
)
from app.services.kanban_list import (
    get_lists, get_list, create_list, update_list, delete_list,
    get_list_with_cards_count, reorder_lists
)
        ...
        with patch('app.routers.lists.list_service.create_list') as mock_create:
            ...
            with patch.object(require_admin, '__call__') as mock_require_admin:
                ...
                with patch('app.routers.lists.get_db') as mock_db:
                    ...
                    result = asyncio.run(create_list_route(
                        list_data, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
                    ))
        ...
        with patch('app.routers.lists.list_service.update_list') as mock_update:
            ...
            with patch.object(require_admin, '__call__') as mock_require_admin:
                ...
                with patch('app.routers.lists.get_db') as mock_db:
                    ...
                    result = asyncio.run(update_list_route(
                        1, 
                        update_data, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
        ...
        with patch('app.routers.lists.list_service.delete_list') as mock_delete:
            ...
            with patch.object(require_admin, '__call__') as mock_require_admin:
                ...
                with patch('app.routers.lists.get_db') as mock_db:
                    ...
                    result = asyncio.run(delete_list_route(
                        1, 
                        deletion_request, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
        ...
        with patch('app.routers.lists.list_service.get_list_with_cards_count') as mock_get_list:
            ...
            with patch('app.routers.lists.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.lists.get_db') as mock_db:
                    ...
                    result = asyncio.run(get_list_cards_count(
                        1, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
                    ))
        ...
        with patch('app.routers.lists.list_service.reorder_lists') as mock_reorder:
            ...
            with patch.object(require_admin, '__call__') as mock_require_admin:
                ...
                with patch('app.routers.lists.get_db') as mock_db:
                    ...
                    result = asyncio.run(reorder_lists_route(
                        reorder_request, 
                        mock_db.return_value.__enter__.return_value, 
                        admin_user
                    ))
    ...
    def test_reorder_lists_permission_denied(self, regular_user):
        ...
        with patch('app.routers.lists.require_admin') as mock_require_admin:
            ...
            with patch('app.routers.lists.get_db') as mock_db:
                ...
                with pytest.raises(HTTPException) as exc_info:
                    asyncio.run(reorder_lists_route(
                        reorder_request,
                        mock_db.return_value.__enter__.return_value,
                        mock_require_admin()
                    ))
