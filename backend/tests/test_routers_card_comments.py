...
from app.schemas.card_comment import (
    CardCommentCreate,
    CardCommentResponse,
    CardCommentUpdate,
)
...
class TestCardCommentsRouter:
    ...
    def test_list_comments_success(self, test_user):
        ...
        with patch(
            "app.routers.card_comments.card_comment_service.get_comments_for_card"
            ...
            with patch(
                "app.routers.card_comments.get_current_active_user"
    ...
    def test_create_comment_success(self, test_user):
        ...
        with patch(
            "app.routers.card_comments.card_comment_service.create_comment"
        ) as mock_create:
            mock_create.return_value = mock_comment

            with patch(
                "app.routers.card_comments.create_card_history_entry"
            ) as mock_history:
    ...
    def test_create_comment_empty_content(self, test_user):
        ...
        assert (
            "commentaire ne peut pas" in str(exc_info.value).lower()
    ...
    def test_update_comment_success(self, test_user):
        ...
        with patch(
            "app.routers.card_comments.card_comment_service.get_comment_by_id"
        ) as mock_get:
            mock_get.return_value = existing_comment

            with patch(
                "app.routers.card_comments.card_comment_service.update_comment"
            ) as mock_update:
    ...
    def test_delete_comment_success(self, test_user, test_comment):
        ...
        with patch(
            ...
            with patch(
                "app.routers.card_comments.card_comment_service.delete_comment"
            ) as mock_delete:
