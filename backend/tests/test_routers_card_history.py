...
from app.services.card_history import get_card_history as service_get_history, create_card_history_entry as service_create_history
            ...
            with patch('app.services.card_history.get_card_history') as mock_get_history:
                ...
                with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
                    ...
                    with patch('app.routers.card_history.get_db') as mock_db:
                        ...
                        result = asyncio.run(get_card_history(1, mock_db.return_value.__enter__.return_value, mock_current_user.return_value))
            ...
            with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.card_history.get_db') as mock_db:
                    ...
                    with pytest.raises(HTTPException) as exc_info:
                        asyncio.run(get_card_history(999, mock_db.return_value.__enter__.return_value, mock_current_user.return_value))
            ...
            with patch('app.services.card_history.create_card_history_entry') as mock_create:
                ...
                with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
                    ...
                    with patch('app.routers.card_history.get_db') as mock_db:
                        ...
                        result = asyncio.run(create_card_history_entry(
                            1, history_data, mock_db.return_value.__enter__.return_value, mock_current_user.return_value
                        ))
        ...
        with patch('app.services.card.get_card') as mock_get_card:
            ...
            with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
                ...
                with patch('app.routers.card_history.get_db') as mock_db:
                    ...
                    with pytest.raises(HTTPException) as exc_info:
                        asyncio.run(create_card_history_entry(
                            999, history_data, mock_db.return_value.__enter__.return_value, mock_current_user.return_value
                        ))
            ...
            with patch('app.routers.card_history.get_db') as mock_db:
                ...
                with patch('app.services.card.get_card') as mock_get_card:
                    ...
                    with pytest.raises(Exception) as exc_info:
                        asyncio.run(get_card_history("invalid", mock_db.return_value.__enter__.return_value, mock_current_user.return_value))
        ...
        with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
            ...
            with patch('app.routers.card_history.get_db') as mock_db:
                ...
                with pytest.raises(Exception):
                    asyncio.run(create_card_history_entry(
                        "invalid", history_data, mock_db.return_value.__enter__.return_value, mock_current_user.return_value
                    ))
    ...
    def test_create_card_history_entry_missing_required_fields(self, test_user):
        ...
        with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
            ...
            with patch('app.routers.card_history.get_db') as mock_db:
                ...
                with pytest.raises(Exception):
                    asyncio.run(create_card_history_entry(
                        1, incomplete_data, mock_db.return_value.__enter__.return_value, mock_current_user.return_value
                    ))
            ...
            with patch('app.services.card_history.get_card_history') as mock_get_history:
                ...
                with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
                    ...
                    with patch('app.routers.card_history.get_db') as mock_db:
                        ...
                        with pytest.raises(Exception) as exc_info:
                            asyncio.run(get_card_history(1, mock_db.return_value.__enter__.return_value, mock_current_user.return_value))
        ...
        with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
            ...
            with patch('app.routers.card_history.get_db') as mock_db:
                ...
                with patch('app.services.card.get_card') as mock_get_card:
                    ...
                    with pytest.raises(HTTPException) as exc_info:
                        asyncio.run(get_card_history(0, mock_db.return_value.__enter__.return_value, mock_current_user.return_value))
        ...
        with patch('app.routers.card_history.get_current_active_user') as mock_current_user:
            ...
            with patch('app.routers.card_history.get_db') as mock_db:
                ...
                with patch('app.services.card.get_card') as mock_get_card:
                    ...
                    with pytest.raises(HTTPException) as exc_info:
                        asyncio.run(create_card_history_entry(
                            0, history_data, mock_db.return_value.__enter__.return_value, mock_current_user.return_value
                        ))
