...
export const listsApi = {
  ...
  async createList(listData: KanbanListCreate): Promise<KanbanList> {
    try {
      const response: AxiosResponse<KanbanList> = await api.post(
        "/lists/",
        listData,
      );
  ...
  async getList(listId: number): Promise<KanbanList> {
    try {
      const response: AxiosResponse<KanbanList> = await api.get(
        `/lists/${listId}`,
      );
  ...
  async updateList(
    listId: number,
    listData: KanbanListUpdate,
  ): Promise<KanbanList> {
    try {
      const response: AxiosResponse<KanbanList> = await api.put(
        `/lists/${listId}`,
        listData,
      );
  ...
  async getListCardsCount(listId: number): Promise<ListWithCardCount> {
    try {
      const response: AxiosResponse<ListCardsCountResponse> = await api.get(
