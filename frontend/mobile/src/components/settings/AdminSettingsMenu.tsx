  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-start gap-2 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg text-xs text-amber-700 dark:text-amber-400">
        ...
        <p>
          {t("settings.comingSoon")}. Les fonctionnalités d'administration
          complètes sont disponibles sur la version desktop.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-muted-foreground">
              Gestion du dictionnaire global
            </div>
          </div>
        </button>
      </div>
