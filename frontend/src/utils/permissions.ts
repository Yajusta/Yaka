...
export const canModifyCardMetadata = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
...
export const canModifyCardContent = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
...
export const canCreateCardItem = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
...
export const canToggleCardItem = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
...
export const canModifyCardItem = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
...
export const canDeleteCardItem = (
  role?: UserRoleValue,
  card?: Card,
  userId?: number,
): boolean => {
