...
export const mockCards = [
  {
    ...
    description:
      "Créer le système de connexion et d'inscription avec validation des données",
  ...
  },
  {
    ...
    description:
      "Les données ne se synchronisent pas correctement entre les différents clients",
    priority: "high" as const,
  ...
  },
  {
    ...
    description:
      "Documenter tous les endpoints de l'API avec des exemples d'utilisation",
  ...
  },
  {
    ...
    description:
      "Analyser et améliorer les requêtes lentes identifiées en production",
    priority: "medium" as const,
    statut: "en_cours" as const,
    due_date: null,
    assignee_id: 2,
  ...
  },
  {
    ...
    description:
      "Ajouter une couverture de tests pour les modules critiques de l'application",
