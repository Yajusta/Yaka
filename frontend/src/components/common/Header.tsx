...
export const Header = ({
  ...
  const [isLanguageMenuHovered, setIsLanguageMenuHovered] =
  ...
  const [isSettingsMenuHovered, setIsSettingsMenuHovered] =
    React.useState(false);
  const [isPersonalDictionaryHovered, setIsPersonalDictionaryHovered] =
    React.useState(false);
  const [isChangingLanguage, setIsChangingLanguage] = React.useState(false);
  const [isUserSettingsExpanded, setIsUserSettingsExpanded] =
    React.useState(false);
      ...
      <div className="px-2 sm:px-4 md:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between h-16 w-full">
          ...
          <div className="flex items-center space-x-3">
            <img src="/yaka.svg" alt="Yaka Logo" className="w-16 h-16" />
          </div>
          ...
          <div className="flex-1 text-center">
            <h1 className="text-xl font-bold text-foreground">
              {loading
                ...
                : boardTitle || "Yaka (Yet Another Kanban App)"}
            </h1>
          </div>
                ...
                <div className="flex items-center justify-start gap-2 p-3">
                  ...
                  <div className="flex flex-col space-y-1 leading-none">
                    ...
                    <div className="flex items-center mt-1">
                      <div
                        className={`w-2 h-2 rounded-full mr-2 ${getRoleIndicatorClass(user?.role)}
                                                `}
                      />
                    ...
                    {user?.role &&
                      (user.role === UserRole.EDITOR ||
                        ...
                        <DropdownMenuItem
                          ...
                          onMouseEnter={() =>
                            setIsPersonalDictionaryHovered(true)
                          }
                          onMouseLeave={() =>
                            setIsPersonalDictionaryHovered(false)
                          }
                        >
