...
export const FilterBar = ({
  ...
  const getActiveFilterCount = (): number => {
    return [
      ...
      filters.priority,
      filters.label_id,
      voiceFilterIds && voiceFilterIds.length > 0,
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 flex-1 min-w-0">
            ...
            >
              ...
              {hasActiveFilters() && (
                <Badge
                  variant="secondary"
                  className="ml-1 md:ml-2 bg-primary text-primary-foreground"
                >
          ...
          <div className="flex items-center gap-2">
            ...
            {canCreateCard && (
              <Button
                ...
                className="bg-primary hover:bg-primary/90 shadow-sm flex-shrink-0"
              >
          ...
          <>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {hasVoiceFilter() && onVoiceFilterClear && (
                <VoiceFilterIndicator
                  onClear={onVoiceFilterClear}
                  description={voiceFilterDescription}
                />
              )}
            </div>
          </>
