    ...
    <div className="h-full flex flex-col">
      ...
      >
        ...
        <div
          ...
          style={
            {
              "--placeholder-height": activeCardSize?.height
                ? `${activeCardSize.height}px`
                : "120px",
        ...
        >
          {(() => {
            ...
            const isActiveCardInThisColumn =
              activeCard && activeCard.list_id === list.id;
            ...
            cards.forEach((card: Card) => {
              ...
              const visibleCardIndex = visibleCards.findIndex(
                (c) => c.id === card.id,
              );

              // Ajouter un placeholder après cette carte si nécessaire
              const shouldShowPlaceholderAfterCard =
                dropTarget === visibleCardIndex + 1 && isDragging;
            ...
            const visibleCardsCount = cards.filter(
              (c) => c.id !== activeCardId,
            ).length;
            const shouldShowPlaceholderAtEnd =
              dropTarget === visibleCardsCount && isDragging;
