    ...
    <div className="p-4 space-y-6">
      ...
      <div className="mt-8 p-4 bg-muted rounded-lg">
        ...
        <ul className="text-sm space-y-1 text-muted-foreground">
          <li>
            • <strong>≤ 3 listes:</strong> Les colonnes s'étendent pour remplir
            la largeur disponible
          </li>
          <li>
            • <strong>&gt; 3 listes:</strong> Largeur fixe (320px) avec
            défilement horizontal
          </li>
          <li>
            • <strong>Responsive:</strong> Largeur minimale réduite sur mobile
            (280px → 260px)
          </li>
          <li>
            • <strong>Scrollbar:</strong> Barre de défilement fine et stylisée
          </li>
          <li>
            • <strong>Espacement:</strong> Gap de 1rem entre les colonnes
          </li>
        </ul>
      </div>
    </div>
